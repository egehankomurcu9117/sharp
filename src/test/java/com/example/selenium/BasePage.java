 ...
 * Bu sınıf, tüm sayfa sınıflarının ortak işlevlerini içerir.
 */
public abstract class BasePage {
    ...
    protected By getLocator(String elementName) {
        return PageLocators.getLocator(pageName, elementName);
    }
    ...
    protected By getDynamicLocator(String elementName, String dynamicValue) {
        return PageLocators.getDynamicLocator(pageName, elementName, dynamicValue);
    }
    ...
    protected void navigateTo(String url) {
        logger.info("{} URL'sine gidiliyor", url);
        driver.get(url);
    }
}
